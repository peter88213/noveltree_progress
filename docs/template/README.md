...
Download the latest release [nv_progress_v0.99.0.pyzw](https://github.com/peter88213/nv_progress/raw/main/dist/nv_progress_v0.99.0.pyzw)

- Launch *nv_progress_v0.99.0.pyzw* by double-clicking (Windows/Linux desktop),
- or execute `python nv_progress_v0.99.0.pyzw` (Windows), resp. `python3 nv_progress_v0.99.0.pyzw` (Linux) on the command line.

### Alternative: Zip file

The package is also available in zip format: [nv_progress_v0.99.0.zip](https://github.com/peter88213/nv_progress/raw/main/dist/nv_progress_v0.99.0.zip)
